%to solve infinite plate with a crack (griffith problem) with
%analytical displacement applied along the boundaries. the code runs for
...
typeProblem = 'Griffith' ; %choose type of problem
