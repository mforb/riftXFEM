function [ outputs ] = f_crack_contact_penalty( p , cd , cu , Kpen  )
% This MATLAB function was created by Martin Forbes (martin.forbes@postgrad.otago.ac.nz)
% The date of creation: Fri Jan  7 12:54:14 NZDT 2022
  ...
  % here we calculate only the normal force at each of the two points
  fu = 0;
  fd = 0;
  fut = 0;
  fdt = 0;
