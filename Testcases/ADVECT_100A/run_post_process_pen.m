...
ld = dir('./PLSTRESS/PEN_OP_*');
pre = './PLSTRESS/';
results_path = './PLSTRESS/PEN';
mkdir(results_path);
global results_path
global zoom_dim
global Hidden
...
melange = 0
melangeforce = 0
E = 9.6e9; nu = 0.33; P = 1 ; elemType = 'T3';
sigmato = P ;
...
l3 = legend({'cumulative angle','angle'})
ax = gca();
ax.FontSize = 14;
...
ylabel('Angle ($^{\circ}$)','interpreter','latex','FontSize',14);
%title('propagation angle','FontSize',fontSize1)
l4 = legend({'cumulative angle','angle'})
