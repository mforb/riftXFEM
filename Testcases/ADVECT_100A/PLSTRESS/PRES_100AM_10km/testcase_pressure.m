...
%srift2 = shaperead('./2021_100a.shp');
...
%{keyboard %}
results_path = './PLSTRESS/PRES_100AM_10km';
mkdir(results_path);
copyfile('testcase_pressure.m',[results_path,'/']);
...
[Knumerical,ThetaInc,xCr,st] = mainXFEM(xCr,numstep,deltaInc);
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PLSTRESS_RXX/PRES_xmas_tip1_20km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PLSTRESS_RXX/PRES_xmas_tip2_10km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PRES_xmas_tip2_15km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PLSTRESS_RXX/PRES_xmas_tip3_5km';
%mkdir(results_path);
