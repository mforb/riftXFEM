...
results_path = './FINAL/MEL1b_t2_tip1_10km';
mkdir(results_path);
...
results_path = './FINAL/MEL1b_t2_tip1_20km';
mkdir(results_path);
copyfile('testcase_melange_m1.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
xCr(1).tip = [0,1];
results_path = './FINAL/MEL1b_t2_tip2_10km';
mkdir(results_path);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
results_path = './FINAL/MEL1b_t2_tip2_15km';
numstep = 4
mkdir(results_path);
copyfile('testcase_melange_m1.m',[results_path,'/']);
run_mesh_prep
...
results_path = './FINAL/MEL1b_t2_tip3_5km';
mkdir(results_path);
copyfile('testcase_melange_m1.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
