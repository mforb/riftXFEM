...
global wall_int stabilize Kpen penalty contact skip_branch skip_vertex
...
for mpen = 1:3 
  for Kpen_i = 1:2 
    for stab_i = 1:3 
      ...
      results_path = ['./BatchTest_M',num2str(mpen),'_K',num2str(log10(Kpen)),'_S',num2str(stab_i),'_W',num2str(wall_ints)];
      mkdir(results_path);
