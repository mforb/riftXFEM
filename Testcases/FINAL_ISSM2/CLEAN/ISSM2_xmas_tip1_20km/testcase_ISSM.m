...
%{keyboard %}
results_path = './CLEAN/ISSM2_xmas_tip1_10km';
mkdir(results_path);
...
close all;
clf;
results_path = './CLEAN/ISSM2_xmas_tip1_20km';
mkdir(results_path);
copyfile('testcase_ISSM.m',[results_path,'/']);
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
close all;
clf;
results_path = './CLEAN/ISSM2_xmas_tip2_10km';
mkdir(results_path);
copyfile('testcase_ISSM.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
results_path = './CLEAN/ISSM2_xmas_tip2_15km';
numstep = 4;
mkdir(results_path);
copyfile('testcase_ISSM.m',[results_path,'/']);
run_mesh_prep
...
results_path = './CLEAN/ISSM2_xmas_tip3_5km';
mkdir(results_path);
copyfile('testcase_ISSM.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
