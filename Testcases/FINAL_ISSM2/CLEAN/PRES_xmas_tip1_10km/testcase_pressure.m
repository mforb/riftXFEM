...
%{keyboard %}
results_path = './CLEAN/PRES_xmas_tip1_10km';
mkdir(results_path);
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PRES_xmas_tip1_20km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PRES_xmas_tip1_30km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PRES_xmas_tip1_40km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
...
%if( strcmp(plotmesh,'YES') )
    ...
    %end
%end
%results_path = './PRES_xmas_tip2_20km';
%mkdir(results_path);
%run_mesh_prep
%zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
%zoom_dim(2,:) = [min(xCr.coor(:,2))-10000,max(xCr.coor(:,2))+10000];
