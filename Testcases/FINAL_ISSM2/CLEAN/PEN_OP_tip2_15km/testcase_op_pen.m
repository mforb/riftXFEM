...
results_path = './CLEAN/PEN_OP_tip1_10km';
mkdir(results_path);
...
results_path = './CLEAN/PEN_OP_tip1_20km';
mkdir(results_path);
copyfile('testcase_op_pen.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
xCr(1).tip = [0,1];
results_path = './CLEAN/PEN_OP_tip2_10km';
mkdir(results_path);
copyfile('testcase_op_pen.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
results_path = './CLEAN/PEN_OP_tip2_15km';
numstep = 4
mkdir(results_path);
copyfile('testcase_op_pen.m',[results_path,'/']);
run_mesh_prep
...
results_path = './CLEAN/PEN_OP_tip3_5km';
mkdir(results_path);
copyfile('testcase_op_pen.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
