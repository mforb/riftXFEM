...
results_path = './FINAL/MEL2_NOQF__tip1_10km';
mkdir(results_path);
...
results_path = './FINAL/MEL2_NOQF__tip1_20km';
mkdir(results_path);
copyfile('testcase_melange_m2.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
xCr(1).tip = [0,1];
results_path = './FINAL/MEL2_NOQF__tip2_10km';
mkdir(results_path);
copyfile('./testcase_melange_m2.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
...
results_path = './FINAL/MEL2_NOQF__tip2_15km';
numstep = 4
mkdir(results_path);
copyfile('testcase_melange_m2.m',[results_path,'/']);
run_mesh_prep
...
results_path = './FINAL/MEL2_NOQF__tip3_5km';
mkdir(results_path);
copyfile('testcase_melange_m2.m',[results_path,'/']);
run_mesh_prep
zoom_dim(1,:) = [min(xCr.coor(:,1))-20000,max(xCr.coor(:,1))+20000];
